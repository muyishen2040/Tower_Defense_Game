...
const int PlateletTurret::Price = 180;
PlateletTurret::PlateletTurret(float x, float y) :
	Turret("play/turret-2.png", x, y, 13, 10, Price, 0.5) {
...
void PlateletTurret::CreateBullet() {
	...
	Engine::Point shoot_start = Position + normalized * 36 - normal * 6;
	getPlayScene()->BulletGroup->AddNewObject(new ShootEffect(shoot_start.x, shoot_start.y));
